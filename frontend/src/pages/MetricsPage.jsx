...
// Use the brand-color CSS var. The --brand-600 var holds an RGB triplet
// (e.g. "232 96 10") per the Tailwind alpha-value setup in index.css, so
// it must be wrapped in rgb(...) to produce a valid CSS color.
const BRAND_COLOR = "rgb(var(--brand-600))";
        ...
        {TABS.map(tab => (
          <button
            ...
            style={{
              ...
              borderBottom: activeTab === tab.id ? `2px solid ${BRAND_COLOR}` : "2px solid transparent",
              background: "transparent",
              color: activeTab === tab.id ? BRAND_COLOR : "#888",
