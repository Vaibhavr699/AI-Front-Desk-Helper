...
const PLANS = {
  basic: {
    ...
    stripeSetupFeeId: "price_1T9PL4G4V3F53niETsVTW4hG", // Basic $197 setup — update in Stripe if needed
    features: {
  ...
  pro: {
    ...
    stripeSetupFeeId: "price_1T9PISG4V3F53niENJUiauRJ", // Pro $297 setup — update in Stripe if needed
    features: {
      aiCallAnswering: true,
      missedCallTextBack: true,
      leadCaptureCrmForwarding: true,
  ...
  elite: {
    ...
    stripeSetupFeeId: "price_1T9PPFG4V3F53niErKhAWvho", // Elite $497 setup — update in Stripe if needed
    features: {
      aiCallAnswering: true,
      missedCallTextBack: true,
      leadCaptureCrmForwarding: true,
  ...
  nurturing_addon: {
    ...
    priceMonthly: 99,
    priceLabel: "/month",
    stripePriceId: "price_NURTURING_ADDON_99", // Placeholder: User must update this in Stripe dashboard
    features: {
      customerNurturingReferral: true,
    },
  },
