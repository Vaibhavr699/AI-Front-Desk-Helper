...
//
// Depends on: migration 037, lib/db.js, lib/resellerPlans.js, lib/resellerBilling.js
// ============================================================================
...
async function handleResellerSubscriptionCreated(subscription) {
  ...
  // TODO Step 6: sendResellerWelcomeEmail
...
async function handleResellerSubscriptionDeleted(subscription) {
  ...
  try {
    ...
    // TODO Step 6: for each transferred customer, create direct Stripe sub
    //              + send sendResellerChurnTransferEmail
