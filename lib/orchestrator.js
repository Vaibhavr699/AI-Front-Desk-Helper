...
const CAPTURE_SERVICE_ZIP_TOOL = {
  type: "function",
  name: "capture_service_zip",
  description:
    "Capture the property's 5-digit ZIP code to route the caller to the correct local team. " +
    "Call this as soon as the caller gives a ZIP or an address you can read a ZIP from, before doing anything else.",
  parameters: {
    type: "object",
    properties: {
      zip: { type: "string", description: "The 5-digit US ZIP code for the property." },
    },
    required: ["zip"],
  },
};
...
module.exports = { getAIConfig, REALTIME_TOOLS, RECOVERY_TOOLS, CAPTURE_SERVICE_ZIP_TOOL };
