    ...
    switch (event.type) {
        case "checkout.session.completed": {
            ...
            if (tenantId && type === "addon_number") {
                ...
                // Flip estimator_addon_purchased=true and store sub ID for cancellation handling.
                await db.query(
                    `UPDATE tenants
        ...
        case "customer.subscription.deleted": {
            ...
            if (tenantId) {
                if (subType === "estimator_addon") {
                    // May 1, 2026 — Phase 7. Estimator add-on cancelled.
                    // Flip purchased=false and clear sub ID, but leave the main plan
