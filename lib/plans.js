...
const PLANS = {
  basic: {
    ...
    priceMonthly: 29,
    priceLabel: "/month",
    stripePriceId: "price_1T7WDPG4V3F53niEwFq0mNYg", // Basic $29/mo
    features: {
  ...
  pro: {
    ...
    priceMonthly: 79,
    priceLabel: "/month",
    stripePriceId: "price_1T7WDmG4V3F53niECifyMljD", // Pro $79/mo
    features: {
      aiCallAnswering: true,
      missedCallTextBack: true,
      leadCaptureCrmForwarding: true,
  ...
  elite: {
    ...
    priceMonthly: 199,
    priceLabel: "/month",
    stripePriceId: "price_1T7WE9G4V3F53niEX2Iz5Ojs", // Elite $199/mo
    features: {
      aiCallAnswering: true,
      missedCallTextBack: true,
      leadCaptureCrmForwarding: true,
