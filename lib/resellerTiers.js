 ...
 *
 * Each tier has 3 Stripe price IDs:
 *   • Flat monthly subscription (the cap-included base)
 *   • Voice metered (per-minute overage)
 *   • SMS metered (per-message overage)
 *
 * Stripe price IDs populate via env vars after products are created in
 * Stripe dashboard. See cron/reportResellerUsage.js for usage reporting.
 */
