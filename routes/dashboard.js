...
router.patch("/tenants/:id", async (req, res) => {
  ...
  let allowed = [
     ...
     "estimator_enabled", "estimator_pop_enabled",
      ...
      // Pre-visit briefing recipient (Phase 8B)
      "pre_visit_sms_enabled", "pre_visit_sms_recipient_phone",
      // Booking notifications (owner alerts, Jun 15 2026)
      "booking_notify_sms_enabled", "booking_notify_email_enabled",
      "booking_notify_sms_phone", "booking_notify_email"
    ];
